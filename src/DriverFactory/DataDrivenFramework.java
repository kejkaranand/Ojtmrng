...
WebDriver driver;
//creating reference object for Function liabray
ERP_Functions erp=new ERP_Functions();

@BeforeTest
public void launchapp()
{
String app=erp.lauchurl("http://webapp.qedge.com");	
...
String result=erp.verifysupplier(sname, address, city, country, cperson,
